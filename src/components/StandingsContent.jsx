...
function StandingsContent({season, mode}) {
  ...
  if (season<1950 || season>currentYear) return <div className="standings-loading-error">No data for this season.</div>
  if (season<1958 && mode === "constructorstandings") return <div className="standings-loading-error">The Constructors Championship was not awarded until 1958</div>
